...
public:
    ...
    // Getters
    [[nodiscard]] uint8_t getVersion() const { return version_; }
    [[nodiscard]] uint32_t getNonce() const { return nonce_; }
    [[nodiscard]] int64_t getSystemFee() const { return systemFee_; }
    [[nodiscard]] int64_t getNetworkFee() const { return networkFee_; }
    ...
    [[nodiscard]] Bytes getHashData() const;
