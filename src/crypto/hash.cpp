...
uint32_t HashUtils::crc32(const Bytes& data) {
...
bool HashUtils::constantTimeEquals(const uint8_t* a, const uint8_t* b, size_t len) {
    // Constant-time comparison to prevent timing attacks
    // Always compares all bytes regardless of where difference occurs
...
bool HashUtils::constantTimeEquals(const Bytes& a, const Bytes& b) {
    if (a.size() != b.size()) {
        return false;
    }
